...
impl LineIndex {
    ...
    /// # use lintal_source_file::{LineIndex, OneIndexed, LineColumn};
    ...
    /// ```
    /// # use lintal_text_size::TextSize;
    /// # use lintal_source_file::{LineIndex, OneIndexed, LineColumn, SourceLocation, PositionEncoding, Line};
    /// let source = format!("\u{FEFF}{}", "def a():\n    pass");
    /// let index = LineIndex::from_source_text(&source);
    ///
    ...
    ///
    /// ```
    /// # use lintal_source_file::{SourceLocation, LineIndex, OneIndexed, PositionEncoding};
    /// # use lintal_text_size::TextSize;
    /// let source = r#"a = 4
    /// c = "some string"
    /// x = b"#;
    ...
    ///
    /// ```
    /// use lintal_source_file::{LineIndex, OneIndexed, SourceLocation, PositionEncoding};
    /// use lintal_text_size::TextSize;
        ...
        let character_byte_offset = if self.is_ascii() {
            ...
            match position_encoding {
                ...
                PositionEncoding::Utf32 => line
                    ...
                    .map(lintal_text_size::TextLen::text_len)
                    .sum(),
            }
        };
...
impl OneIndexed {
    ...
    ///
    /// ```
    /// use lintal_source_file::OneIndexed;
    ///
